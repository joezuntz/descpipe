...
class CWLLauncher(Launcher):
    ...
    def _generate_stage_tool(self, dirname, stage_name, stage_class):
        ...
        tool['baseCommand'] = '/opt/desc/run.py'.split()
    ...
    def generate(self, dirname):
        ...
        for stage_name, stage_class in self.pipeline.sequence():
            ...
            for tag in stage_class.config:
                ...
                path = self.pipeline.cfg[stage_name]['config'][tag]
        ...
        cmd = "TMPDIR={tmpdir} cwltool {user_flag} --outdir={outdir} {dirname}/workflow.cwl {dirname}/job.yml".format(
